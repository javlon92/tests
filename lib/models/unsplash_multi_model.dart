...
List<Unsplash> unsplashFromJson(String str) =>
    List<Unsplash>.from(jsonDecode(str).map((x) => Unsplash.fromJson(x)));

String unsplashToJson(List<Unsplash> data) =>
...
class Unsplash {
  ...
  factory Unsplash.fromJson(Map<String, dynamic> json) => Unsplash(
    ...
    List<String>.from(json["current_user_collections"].map((x) => x)):[],
  ...
  Map<String, dynamic> toJson() => {
    ...
    List<String>.from(currentUserCollections!.map((x) => x)),
...
class Sponsorship {
  ...
  Map<String, dynamic> toJson() => {
    "impression_urls": List<String>.from(impressionUrls!.map((x) => x)),
    "tagline": tagline,
